...
public class ItemListViewHolder extends RecyclerView.ViewHolder {
   ...
   private Context context;
    ...
    public ItemListViewHolder(View view, ItemListViewHolderListener listener) {
        super(view);
    ...
    public void onBind(final Item item) {
        ...
        @SuppressLint("SimpleDateFormat") SimpleDateFormat dateFormat = new SimpleDateFormat(DateFormats.Day_Month_Year.getFormat());
